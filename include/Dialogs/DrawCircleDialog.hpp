...
public:
CircleDialog():QDialog(){
    setWindowTitle(tr("Circle Dialog"));
    pie=3.14159265;
   ...
   negZDirect=std::make_unique<QRadioButton>(tr("-Z Direction"));
    ...
    connect(radiusEdit.get(),&DoubleEdit::GetValue,this,&CircleDialog::OnGetRadius);
    connect(angleEdit.get(),&DoubleEdit::GetValue,this,&CircleDialog::OnGetAngle);
    connect(dialogButtons.get(),&QDialogButtonBox::rejected,this,&CircleDialog::HandleCancel);
    connect(dialogButtons.get(),&QDialogButtonBox::accepted,this,&CircleDialog::HandleOk);
    connect(xDirect.get(),&QRadioButton::toggled,this,&CircleDialog::OnHandleChecked);
    connect(yDirect.get(),&QRadioButton::toggled,this,&CircleDialog::OnHandleChecked);
    connect(zDirect.get(),&QRadioButton::toggled,this,&CircleDialog::OnHandleChecked);
    connect(negXDirect.get(),&QRadioButton::toggled,this,&CircleDialog::OnHandleChecked);
    connect(negYDirect.get(),&QRadioButton::toggled,this,&CircleDialog::OnHandleChecked);
    connect(negZDirect.get(),&QRadioButton::toggled,this,&CircleDialog::OnHandleChecked);
    connect(axisX.get(),&QRadioButton::toggled,this,&CircleDialog::OnHandleChecked);
    connect(axisY.get(),&QRadioButton::toggled,this,&CircleDialog::OnHandleChecked); 
   connect(axisZ.get(),&QRadioButton::toggled,this,&CircleDialog::OnHandleChecked);
}
...
void OnDisplay(){
    ...
    drawAxis.Rotate(axisOfRotation,rad);
     ...
     Handle(Geom_Circle) circle=new Geom_Circle(drawAxis,radius);
